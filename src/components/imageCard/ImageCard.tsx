...
export const ImageCard: React.FC<ImageCardProps> = ({nome, dataUpload, src, tamanho, extension}: ImageCardProps) => { /* Component card de imagens! */
   function download (){
   ...
   return(
    ...
    function formatBytes(bytes: number = 0, decimals = 2){ // Formatando o tamamho
